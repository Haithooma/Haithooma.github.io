jQuery("#simulation")
  .on("click", ".s-d12245cc-1680-458d-89dd-4f0d7fb22724 .click", function(event, data) {
    ...
    if(jFirer.is("#s-Browse")) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/81657c21-d5c4-49a4-9479-f43cf3630bdc"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-ok_button_1")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/c79acb03-8893-447b-8c1d-c6f5e3f2a79b"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-ok_button_2")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/2b7f3c94-b229-4fc8-abae-b7d4a923a9a6"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
